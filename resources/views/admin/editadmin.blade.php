    ...
    <div class="card-body">
      <form method="POST" action="{{ route('admin.updateadmin', $admin->id) }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" id="nama" name="nama" class="form-control" value="{{ $admin->nama }}" required>
        </div>
        ...
        <button type="submit" class="btn btn-success mt-3 rounded-pill">Perbarui</button>
